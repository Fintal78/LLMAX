...
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/thinking-models-research.md
...
```bash
node "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
