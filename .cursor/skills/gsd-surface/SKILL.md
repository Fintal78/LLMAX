...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.gsd-surface.json`
(sibling to `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/skills`).
...
`C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.gsd-surface.json`
Install profile marker: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.gsd-profile`
Skill dirs: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/skills/gsd-*/`
Engine module: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
