...
Key references:
- @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/ui-brand.md (display patterns)
- @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md" "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/user-profiling.md`
...
Reference: @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/.cursor/rules/
```
