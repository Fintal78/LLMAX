...
```bash
INIT=$(node "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/templates/spec.md.
