...
<required_reading>
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/ai-frameworks.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/agents/gsd-eval-planner.md for instructions.
