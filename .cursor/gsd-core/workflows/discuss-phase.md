...
<required_reading>
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/domain-probes.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/gate-prompts.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
