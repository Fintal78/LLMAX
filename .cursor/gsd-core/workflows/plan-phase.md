...
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/ui-brand.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/revision-loop.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/gate-prompts.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/agent-contracts.md
@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/gates.md
</required_reading>
...
- Planner is instructed to produce `SKELETON.md` in the phase directory alongside `PLAN.md`. The template lives at `@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/skeleton-template.md`.
...
**If found:**
1. Read template: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/templates/VALIDATION.md`
...
UI_GATE_JS=$(for _c in "$_GSD_RT/gsd-core/bin/lib/ui-safety-gate.cjs" "$_GSD_RT/bin/lib/ui-safety-gate.cjs" "$_GSD_RT/.claude/bin/lib/ui-safety-gate.cjs" "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/bin/lib/ui-safety-gate.cjs" "C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/bin/lib/ui-safety-gate.cjs"; do [ -f "$_c" ] && { echo "$_c"; break; }; done)
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/tdd.md to all eligible tasks:
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
...
${MVP_MODE === 'true' ? `
<mvp_mode_active>
**MVP Mode is ENABLED.** Follow vertical-slice planning rules from @C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/references/planner-mvp-mode.md. Each plan must deliver a complete vertical slice — thin end-to-end functionality rather than horizontal layers.
</mvp_mode_active>
` : ''}
</planning_context>
