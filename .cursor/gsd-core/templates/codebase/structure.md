...
- Usage: Reference from command with `@C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
