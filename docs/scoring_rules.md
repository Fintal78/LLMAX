...
> [!NOTE]
>
> **Global Reference:** This calculated Process Node Score is the authoritative value used by both the **Battery Endurance Model (Section 8.1)** and the **AI Hardware Performance Model (Section 3.10)**.
...
4)  **Justification:**
    ...
    b)   **Unaccounted Reason (Gap):** The explicit explanation of *why* this feature is not captured by the standard scoring rules of Sections 1-10.
         ...
         *   **Context Source Support:** If a `Context:` explanation is provided, an additional supporting **URL LINKING** to a credible technical deep-dive MUST be provided inline within the same string to prove this context (e.g., `...without hardware changes (Source: https://www.apple.com/newsroom/2023/09/apple-unveils-iphone-15-pro-and-iphone-15-pro-max/).`). See example 11.1 below.
