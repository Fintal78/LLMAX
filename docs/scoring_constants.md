...
*   `NPU_TOPS_Min` = 0.5 (Score 0), `NPU_TOPS_Max` = 50 (Score 10) 

### 6.5 RAM Technology - Memory Technology Efficiency Index (MTEI)
*   `RAM_MTS_Min` = 1600 (Score 0 | LPDDR3 Baseline), `RAM_MTS_Max` = 10667 (Score 10 | LPDDR5X Ceiling)
...
*   `Battery_Universal_Wired_W_Min` = 0.0 (Score 0.0 | Absolute floor for devices lacking universal USB Power Delivery support or open fallback protocol across 2016–2026)
*   `Battery_Universal_Wired_W_Max` = 100.0 (Score 10.0 | Gold standard universal USB-PD 3.0 Standard Power Range specification peak reached by high-power PPS and dual-port flagships across 2016–2026)
...
*   `Battery_Universal_Wireless_W_Min` = 0.0 (Score 0.0 | No universal wireless charging support)
*   `Battery_Universal_Wireless_W_Max` = 25.0 (Score 10.0 | The gold standard universal open Qi v2.2 specification peak)

### 8.4 Wired Reverse Charging
*   `Battery_Reverse_Wired_W_Min` = 0.0 (Score 0.0 | No reverse charging floor)
