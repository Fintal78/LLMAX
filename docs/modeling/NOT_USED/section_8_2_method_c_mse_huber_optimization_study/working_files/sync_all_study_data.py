...
# Master script to ensure 100% mathematical coherence across all tables in section_8_2 study doc
...
def main():
    print("Generating single source of truth for all 4 models...")

    # Single optimization runs for candidate models
    ...
    # Extended Huber sweep using the EXACT SAME optimization function for delta=10.0
    sweep = []
    ...
    for i, d in enumerate(BENCHMARK_DEVICES):
        ...
        (eta_CCCV, C_thresh, k, p, s_low, T_handshake,
         eta_arch_s, eta_cp, eta_pps, eta_fpd, eta_5v, eta_app) = p_hub
    ...
    with open("scratch/synced_master_study_data.json", "w") as f:
        json.dump(master_data, f, indent=2)

    print("SUCCESS: Synced master data written to scratch/synced_master_study_data.json!")
