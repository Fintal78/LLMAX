...
# Physical search domains with realistic physical boundaries
PARAM_BOUNDS = [
    ...
    (0.95, 1.30),    # F_charge_pump (Physical ceiling ~1.30 for direct drive)
    (0.90, 1.25),    # F_pps
...
def global_optimize(loss_type, bounds, delta=10.0, num_trials=80000, seed=42):
    random.seed(seed)
...
print("=== FINAL MULTI-START GLOBAL OPTIMIZATION ===")
