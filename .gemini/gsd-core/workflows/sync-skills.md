...
INSTALL_JS_GLOBAL="C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
