...
- **Global scope**: `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/notes/`)
...
2. Glob `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/notes/` — works in any directory
