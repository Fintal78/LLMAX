...
The keys live in `.claude/settings.json` (project) or `C:/Users/Ion/.gemini/antigravity/scratch/smartphone_db/.gemini/settings.json` (global) — **not** in `.planning/config.json`:
